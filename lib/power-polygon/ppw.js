...
window.PPW = (function ($, _d, console){
    ...
    var _self = this,
        ...
        _templates= {
            ...
            // the loading element
            //loading: "<div id='ppw-lock-loading' style='position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; background: #dadada url(/ppw/_images/ppw-gray-bg.png); padding: 10px; font-family: Arial; z-index: 999999999;'>\ BUG
            loading: function() { return "<div id='ppw-lock-loading' style='position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; background: #dadada url(" + _createPPWSrcPath("/_images/ppw-gray-bg.png") + "); padding: 10px; font-family: Arial; z-index: 999999999;'>\
...
//            _loadStyle(_createPPWSrcPath('/_styles/introjs.css'), true, function(){_setLoadingBarStatus('IntroJS.css');}, true);
    ...
    var _initRemoteService= function(){
        ...
        if(!PPW.remote.server){
            ...
            //_loadScript('/ppw/_tools/remote/server.js'); BUG
            _loadScript(_createPPWSrcPath('/_tools/remote/server.js'));
